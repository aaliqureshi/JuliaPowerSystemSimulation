...
function fx!(du,u,p,t)
    ...
    # δ,ω,i_13d,i_13q,i_32d,i_32q,i_30d,i_30q = u
...
function solve_init(params,p0::Array{Float64})
    ...
    res2 = [δ0,ω0,i_13d0,i_13q0,i_32d0,i_32q0,i_30d0,i_30q0,v_1d0,v_1q0,v_3d0,v_3q0]


    # return (res,e_q_prime0)
    return (res2,e_q_prime0)
